...
public class Aggregate extends Operator {
    ...
    public Aggregate(DbIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        if (afieldType == Type.INT_TYPE) {
            ...
            throw new UnsupportedOperationException("Unsupported type: " + afieldType);
        }
    }
    ...
    public String groupFieldName() {
        // some code goes here
        return this.gfield == Aggregator.NO_GROUPING ? null : child.getTupleDesc().getFieldName(this.gfield);
    }
